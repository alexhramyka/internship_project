...
VALUES (2, 'password', 'mail1@mail.com', 'User23', 'User1' , true, 'ADMIN', current_date, current_date),
       (3, 'password', 'mail2@mail.com', 'User23', 'User2' , true, 'EMPLOYEE', current_date, current_date),

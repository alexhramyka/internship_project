...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  private static final String[] ALL_USERS_PERMISSION = new String[] {"/api/users/**", "/api/projects/{id}", "/api/departments/{id}"};
  ...
  private static final String[] WRITE_DELETE_USER_PERMISSION = new String[] {"/api/departments/**", "/api/projects/**", "/api/report/**"};
